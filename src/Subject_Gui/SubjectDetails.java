...
public class SubjectDetails extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
      SubjectDetailsUpdate subjectDetailsUpdate= new SubjectDetailsUpdate();
      subjectDetailsUpdate.setExtendedState(JFrame.MAXIMIZED_BOTH);
      subjectDetailsUpdate.setVisible(true);
      this.dispose();
